...
* {Add <tt>user_agent</tt> methods to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/0fc68f1c52e3b754194fe8a9cfbd9d4499eacbe1]
* {Add <tt>locale</tt> method to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/584bcf9eb896530a87e4122fb1a020c35744f0cf]
...
=== 0.9.0 - March 20, 2010
* {Add <tt>retweeters_of</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/7de2d6204028b6741ce7a72b12efe868e074331c]
...
* {Add <tt>next_page?</tt> and <tt>fetch_next_page</tt> methods to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/767ddaa62e8fa9e3872ddd17323f323d9f1393e4] (@cyu[http://twitter.com/#!/cyu])
...
* {Add <tt>phrase</tt> method to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/e3e8f7e4b1ea8a315f935805e409a3fff6a5483d] (@zagari[http://twitter.com/#!/zagari])
* {Add <tt>available</tt> and <tt>location</tt> methods to <tt>Trends</tt> class}[http://github.com/jnunemaker/twitter/commit/39b8d8dd3bb25cb5cd081cae23486fb47c25ec8f]

=== 0.8.3 - January 29, 2010
* {Add unauthenticated <tt>list_timeline</tt> method}[http://github.com/jnunemaker/twitter/commit/aed3a298b613a508bb9caf93afc7f12c50626ad7] (@spastorino[http://twitter.com/#!/spastorino])

=== 0.8.2 - January 21, 2010
* {Add <tt>update_profile_image</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/10afe76daef3a2b8e10917b9550724cc9c3a6c19] (@urajat[http://twitter.com/#!/urajat])

=== 0.8.1 - January 12, 2010
* {Add unauthenticated <tt>timeline</tt> method}[http://github.com/jnunemaker/twitter/commit/dc26a0c9b5a6a98aec4ca9c0a48333e665c9bf18]
...
* {Add <tt>blocks</tt> and <tt>blocking</tt> methods to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/0eb099001f060431c56c1884d86abb2e53a09c6d]

=== 0.7.9- December 1, 2009
* {Add <tt>retweets</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/a1a834575000bbb8fb430632b6bf88e19daeb8fb] (@ivey[http://twitter.com/#!/ivey])
...
* {Add <tt>update_profile_background</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/3eeed693180d15ba4ca2370c41bd5547f715fc88] (@kev_in[http://twitter.com/#!/kev_in])
* {Add <tt>blocked_ids</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/2a5046500eb30141f55552d9b151857d08a1436a] (@rizwanreza[http://twitter.com/#!/rizwanreza])
* {Add <tt>since_date</tt> and <tt>until_date</tt> methods to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/9dcd340817224fa34fcb515f79a846886ffa1427] (@jschairb[http://twitter.com/#!/jschairb])

=== 0.7.6- November 25, 2009
* {Add <tt>home_timeline</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/2de3786e75e6a1725572d3f08f6886f64e507851] (@coderifous[http://twitter.com/#!/coderifous])
...
* {Add <tt>list_subscriptions</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/2273c8a4e7c5d496922fc34551b46b22d30b68aa] (@christospappas[http://twitter.com/#!/christospappas])

=== 0.7.2- November 5, 2009
* {Add <tt>friendship_show</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/693f95a6a19dd51c047078ef969e14357930bcd7] (@dcrec1[http://twitter.com/#!/dcrec1])
...
* {Add <tt>user_agent</tt> method to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/e8fbad6a9cfdcfaad4938f7243fc971a1ea8ac8c]
...
=== 0.6.10 - May 18, 2009
* {Add <tt>current</tt>}[http://github.com/jnunemaker/twitter/commit/549f34903be38232c24044d9972629a86a0503a4], {<tt>daily</tt>, and <tt>weekly</tt> methods to <tt>Trends</tt> class}[http://github.com/jnunemaker/twitter/commit/dc8046aea5794303f6f36622221a412a4e80f9a8]
...
* {Add unauthenticated <tt>status</tt>, <tt>friend_ids</tt>, and <tt>follower_ids</tt> methods}[http://github.com/jnunemaker/twitter/commit/55813617c5b4cf672800bf7f9e7473904e3c3194]
...
=== 0.6.3 - April 14, 2009
* {Add unauthenticated <tt>user</tt> method}[http://github.com/jnunemaker/twitter/commit/cb46975eaa8aa7e02ad798ba8b7b62017f15604c]

=== 0.6.2 - April 14, 2009
* {Add <tt>max</tt> method to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/e79cc1fdb306da24462c6617b118e03ccbead9f1]
...
* {Add <tt>friend_ids</tt> and <tt>follower_ids</tt> methods to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/b70718cc31684af6ce2d1c2a11adaaba29ea7b92] (@joshowens[http://twitter.com/#!/joshowens])
...
* {Add <tt>page</tt> method to <tt>Search</tt> class}[http://github.com/jnunemaker/twitter/commit/977023126fbe7fdf13af53d840ca3b6807cd2d85] (@ivey[http://twitter.com/#!/ivey])
...
* {Add <tt>source</tt> method to <tt>Status</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>truncated</tt> method to <tt>Status</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>in_reply_to_status_id</tt> method to <tt>Status</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>in_reply_to_user_id</tt> method to <tt>Status</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>favorited</tt> method to <tt>Status</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>protected</tt> method to <tt>User</tt> class}[http://github.com/jnunemaker/twitter/commit/d02d233000667c74101571f9362532a57715ae4e]
* {Add <tt>friendship_exists?</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>update_location</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>update_delivery_device</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>favorites</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>create_favorite</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>destroy_favorite</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>block</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
* {Add <tt>unblock</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/eeca67c5693dc175cf1990c2657a6efd8c4cbd6d]
...
Any method passing <tt>lite</tt> or <tt>since</tt> parameters will no longer work with this version. Simply pass the parameters in a <tt>Hash</tt> instead. For example: <tt>friends(true)</tt> becomes <tt>friends(:lite => true)</tt>

=== 0.2.7 - June 29, 2008
* {Add <tt>rate_limit_status</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/2b5325b1875574805fde77f30d0df84e423272e5] (@danielmorrison[http://twitter.com/#!/danielmorrison])
...
* {Add <tt>leave</tt> and <tt>follow</tt> methods to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/4878689063574ad88ea76343387094fc634ccead]
...
* {Add <tt>sent_messages</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>create_friendship</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>destroy_friendship</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>featured</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>replies</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>destroy</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>status</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add Active Support dependency}[http://github.com/jnunemaker/twitter/commit/c2d8c55516747627452224af8faecc15ee6b5fd4]
* {Add <tt>d</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/139a820de0bcc97ece7e33435535985555231bc8] (@jnewland[http://twitter.com/#!/jnewland])
* {Fix <tt>since</tt> parameter in <tt>direct_messages</tt> method}[http://github.com/jnunemaker/twitter/commit/41a9006be9221d7305752639ac4440b3a8859cd0] (@jnewland[http://twitter.com/#!/jnewland])

=== 0.1.1 - May 20, 2007
* {Add support for Hpricot 0.5+}[http://github.com/jnunemaker/twitter/commit/4aa2fabaa62c60e9f11f29510db10b6ed406e510] (@erebor[http://twitter.com/#!/erebor] is the man!)

=== 0.1.0 - March 31, 2007
* {Add <tt>d</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/13e031f8d2e8db6ca8ace18a25886fb690d580d2]
* {Add <tt>direct_messages</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/0f4d699a5310dc8a4e2997b82853f5466292b320]
* {Add <tt>featured</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/21ca95ffa3f42aaf7728c3d5c2aa5f1f9ed84fe7]
* {Add <tt>friends_for</tt> method to <tt>Base</tt> class}[http://github.com/jnunemaker/twitter/commit/21ca95ffa3f42aaf7728c3d5c2aa5f1f9ed84fe7]
...
* {Add <tt>location</tt>, <tt>description</tt>, <tt>url</tt>, and <tt>profile_image_url</tt> methods to <tt>User</tt> class}[http://github.com/jnunemaker/twitter/commit/e6737ec8b07b9fd1ffd96a21074a100a6fb3cf7e] (@al3x[http://twitter.com/#!/al3x])
