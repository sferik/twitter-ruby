...
describe Twitter::OEmbed do
  describe "#author_uri" do
    ...
    it "returns nil when the author_uri is not set" do
      ...
      assert_predicate(oembed.author_uri, :nil?)
    end
  end
  ...
  describe "#author_name" do
    ...
    it "returns nil when not set" do
      ...
      assert_predicate(author_name, :nil?)
    end
  end
  ...
  describe "#cache_age" do
    ...
    it "returns nil when not set" do
      ...
      assert_predicate(cache_age, :nil?)
    end
  end
  ...
  describe "#provider_name" do
    ...
    it "returns nil when not set" do
      ...
      assert_predicate(provider_name, :nil?)
    end
  end
  ...
  describe "#provider_uri" do
    ...
    it "returns nil when the provider_uri is not set" do
      ...
      assert_predicate(oembed.provider_uri, :nil?)
    end
  end
  ...
  describe "#uri" do
    ...
    it "returns nil when the url is not set" do
      ...
      assert_predicate(oembed.uri, :nil?)
    end
  end
