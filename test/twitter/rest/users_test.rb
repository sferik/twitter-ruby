...
describe Twitter::REST::Users do
  ...
  describe "#blocked_ids" do
    ...
    describe "with multiple positional arguments" do
      ...
      it "uses the last positional argument as the user" do
        @client.blocked_ids("ignored", 7_505_382)
  ...
  describe "#contributees" do
    ...
    describe "with multiple positional arguments" do
      ...
      it "uses the last positional argument as the user" do
        @client.contributees("ignored", "sferik")
  ...
  describe "#update_profile_banner" do
    ...
    it "returns true and merges the banner into options using the :banner key" do
      ...
      @client.stub(:perform_post, lambda { |path, options|
        ...
        assert @client.update_profile_banner(banner, width: 800)
      end
    end
  end
  ...
  describe "#profile_banner" do
    ...
    describe "with multiple positional arguments" do
      ...
      it "uses the last positional argument as the user" do
        @client.profile_banner("ignored", "sferik")
  ...
  describe "#muted_ids" do
    ...
    describe "with multiple positional arguments" do
      ...
      it "uses the last positional argument as the user" do
        @client.muted_ids("ignored", 7_505_382)
