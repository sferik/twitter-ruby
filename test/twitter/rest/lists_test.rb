...
describe Twitter::REST::Lists do
  ...
  describe "#list_timeline" do
    describe "with a screen name passed" do
      ...
      describe "with extra positional arguments" do
        it "uses the last arguments for list and owner" do
          stub_get("/1.1/lists/statuses.json").with(query: {owner_screen_name: "sferik", slug: "presidents"}).to_return(body: fixture("statuses.json"), headers: json_headers)
          @client.list_timeline("extra", "sferik", "presidents")
  ...
  describe "#add_list_members" do
    ...
    describe "with extra positional arguments" do
      ...
      it "uses the last arguments for members, list, and owner" do
        @client.add_list_members("extra", "sferik", "presidents", [813_286, 18_755_393])
  ...
  describe "#list_member?" do
    ...
    describe "with extra positional arguments" do
      ...
      it "uses the last arguments for user, list, and owner" do
        @client.list_member?("extra", "sferik", "presidents", 813_286)
  ...
  describe "#list_members" do
    ...
    describe "with extra positional arguments" do
      ...
      it "uses the last arguments for list and owner" do
        @client.list_members("extra", "sferik", "presidents")
  ...
  describe "#add_list_member" do
    ...
    describe "with extra positional arguments" do
      ...
      it "uses the last arguments for user, list, and owner" do
        @client.add_list_member("extra", "sferik", "presidents", 813_286)
  ...
  describe "#destroy_list" do
    ...
    describe "with extra positional arguments" do
      ...
      it "uses the last arguments for list and owner" do
        @client.destroy_list("extra", "sferik", "presidents")
