...
describe Twitter::Headers do
  ...
  describe "#initialize" do
    ...
    it "extracts bearer_token_request from options" do
      ...
      assert_predicate headers, :bearer_token_request?
    end
  ...
  describe "#bearer_token_request?" do
    ...
    it "returns false when bearer_token_request option was not set" do
      ...
      refute_predicate headers, :bearer_token_request?
    end
  ...
  describe "#oauth_auth_header" do
    ...
    it "passes URL as a String to SimpleOAuth::Header" do
      custom_uri = Class.new do
        def to_s = "http://example.com/to_s"

        def to_str = "http://example.com/to_str"
      end.new
      ...
      assert_equal("http://example.com/to_s", url_passed)
    end
