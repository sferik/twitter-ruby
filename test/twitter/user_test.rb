...
describe Twitter::User do
  ...
  describe "#profile_banner_uri" do
    ...
    it "does not trigger deprecated hash access internally" do
      ...
      assert_false(capture_io { user.profile_banner_uri }.last.include?("DEPRECATION"))
    end
  ...
  describe "#profile_banner_uri_https" do
    ...
    it "does not trigger deprecated hash access internally" do
      ...
      assert_false(capture_io { user.profile_banner_uri_https }.last.include?("DEPRECATION"))
    end
  ...
  describe "#profile_image_uri" do
    ...
    it "does not trigger deprecated hash access internally" do
      ...
      assert_false(capture_io { user.profile_image_uri }.last.include?("DEPRECATION"))
    end
  ...
  describe "#profile_image_uri_https" do
    ...
    it "does not trigger deprecated hash access internally" do
      ...
      assert_false(capture_io { user.profile_image_uri_https }.last.include?("DEPRECATION"))
    end
  ...
  describe "#status" do
    ...
    it "returns nil when status is not set" do
      ...
      assert_predicate(user.status, :nil?)
    end
