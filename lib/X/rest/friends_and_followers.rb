...
module X
  module REST
    module FriendsAndFollowers
      ...
      # @see https://dev.X.com/rest/reference/get/friends/ids
      # @rate_limited Yes
      ...
      # @see https://dev.X.com/rest/reference/get/followers/ids
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      #
      # @see https://dev.X.com/rest/reference/get/friendships/lookup
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      def friendships(*args)
        ...
        perform_get_with_objects("/1.1/friendships/lookup.json", arguments.options, X::User)
      end

      # Returns an array of numeric IDs for every user who has a pending request to follow the authenticating user
      #
      # @see https://dev.X.com/rest/reference/get/friendships/incoming
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      #
      # @see https://dev.X.com/rest/reference/get/friendships/outgoing
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      #
      # @see https://dev.X.com/rest/reference/post/friendships/create
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The followed users.
      ...
      def follow!(*args)
        ...
        pmap(arguments) do |user|
          perform_post_with_object("/1.1/friendships/create.json", merge_user(arguments.options, user), X::User)
        end.compact
      end
      alias create_friendship! follow!
      ...
      #
      # @see https://dev.X.com/rest/reference/post/friendships/destroy
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The unfollowed users.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/friendships/update
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      def friendship_update(user, options = {})
        ...
        perform_post_with_object("/1.1/friendships/update.json", options, X::Relationship)
      end

      # Returns detailed information about the relationship between two users
      #
      # @see https://dev.X.com/rest/reference/get/friendships/show
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Relationship]
      # @param source [Integer, String, X::User] The X user ID, screen name, or object of the source user.
      # @param target [Integer, String, X::User] The X user ID, screen name, or object of the target user.
      # @param options [Hash] A customizable set of options.
      def friendship(source, target, options = {})
        ...
        perform_get_with_object("/1.1/friendships/show.json", options, X::Relationship)
      end
      ...
      #
      # @see https://dev.X.com/rest/reference/get/followers/list
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      #   @option options [Boolean, String, Integer] :include_user_entities The user entities node will be disincluded when set to false.
      def followers(*args)
        cursor_from_response_with_user(:users, X::User, "/1.1/followers/list.json", args)
      end

      # Returns a cursored collection of user objects for every user the specified user is following (otherwise known as their "friends").
      #
      # @see https://dev.X.com/rest/reference/get/friends/list
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      #   @option options [Boolean, String, Integer] :include_user_entities The user entities node will be disincluded when set to false.
      def friends(*args)
        cursor_from_response_with_user(:users, X::User, "/1.1/friends/list.json", args)
      end
      ...
      # @see https://dev.X.com/rest/reference/get/friendships/no_retweets/ids
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
