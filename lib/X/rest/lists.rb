...
module X
  module REST
    module Lists
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/list
      # @rate_limited Yes
      ...
      #   @option options [Boolean] :reverse Set this to true if you would like owned lists to be returned first.
      def lists(*args)
        objects_from_response_with_user(X::List, :get, "/1.1/lists/list.json", args)
      end
      alias lists_subscribed_to lists

      # Show tweet timeline for members of the specified list
      #
      # @see https://dev.X.com/rest/reference/get/lists/statuses
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::Tweet>]
      # @overload list_timeline(list, options = {})
      #   @param list [Integer, String, X::List] A X list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      ...
      def list_timeline(*args)
        ...
        perform_get_with_objects("/1.1/lists/statuses.json", arguments.options, X::Tweet)
      end

      # Removes the specified member from the list
      #
      # @see https://dev.X.com/rest/reference/post/lists/members/destroy
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::List] The list.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/memberships
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      def memberships(*args)
        cursor_from_response_with_user(:lists, X::List, "/1.1/lists/memberships.json", args)
      end

      # Returns the subscribers of the specified list
      #
      # @see https://dev.X.com/rest/reference/get/lists/subscribers
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor] The subscribers of the specified list.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/subscribers/create
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::List] The specified list.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/subscribers/show
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      #   @param list [Integer, String, X::List] A X list ID, slug, URI, or object.
      #   @param user_to_check [Integer, String, X::User] A X user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/subscribers/destroy
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/members/create_all
      ...
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Forbidden] Error raised when user has already been added.
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::List] The list.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/members/show
      # @authentication Requires user context
      # @rate_limited Yes
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/members
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/members/create
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/destroy
      # @note Must be owned by the authenticated user.
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::List] The deleted list.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/update
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::List] The created list.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/lists/create
      ...
      def create_list(name, options = {})
        perform_post_with_object("/1.1/lists/create.json", options.merge(name: name), X::List)
      end

      # Show the specified list
      #
      # @see https://dev.X.com/rest/reference/get/lists/show
      ...
      #
      # @see https://dev.X.com/rest/reference/get/lists/subscriptions
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor]
      ...
      def subscriptions(*args)
        cursor_from_response_with_user(:lists, X::List, "/1.1/lists/subscriptions.json", args)
      end

      # Removes specified members from the list
      #
      # @see https://dev.X.com/rest/reference/post/lists/members/destroy_all
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::NotFound] Error raised when supplied list is not found.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      ...
      # Returns the lists owned by the specified X user
      #
      # @see https://dev.X.com/rest/reference/get/lists/ownerships
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::List>]
      ...
      def owned_lists(*args)
        cursor_from_response_with_user(:lists, X::List, "/1.1/lists/ownerships.json", args)
      end
    ...
    private
      ...
      def list_from_response(request_method, path, args)
        ...
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        perform_request_with_object(request_method, path, arguments.options, X::List)
      end
      ...
      def cursor_from_response_with_list(path, args)
        ...
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        perform_get_with_cursor(path, arguments.options, :users, X::User)
      end
      ...
      def list_user?(request_method, path, args)
        ...
        true
      rescue X::Error::Forbidden, X::Error::NotFound
        false
      end
      ...
      def list_from_response_with_user(path, args)
        ...
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        perform_post_with_object(path, arguments.options, X::List)
      end
      ...
      def list_from_response_with_users(path, args)
        ...
        pmap(members.each_slice(MAX_USERS_PER_REQUEST)) do |users|
          perform_post_with_object(path, merge_users(options, users), X::List)
        end.last
      end
      ...
      #
      # @param hash [Hash]
      # @param list [Integer, String, URI, X::List] A X list ID, slug, URI, or object.
      def merge_list!(hash, list)
        case list
        when Integer               then hash[:list_id] = list
        when X::List         then merge_list_and_owner!(hash, list)
      ...
      #
      # @param hash [Hash]
      # @param user[Integer, String, X::User] A X user ID, screen_name, or object.
      # @return [Hash]
