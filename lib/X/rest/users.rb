...
module X
  module REST
    module Users
      ...
      #
      # @see https://dev.X.com/rest/reference/post/account/settings
      # @see https://dev.X.com/rest/reference/get/account/settings
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Settings]
      # @param options [Hash] A customizable set of options.
      # @option options [Integer] :trend_location_woeid The Yahoo! Where On Earth ID to use as the user's default trend location. Global information is available by using 1 as the WOEID. The woeid must be one of the locations returned by {https://dev.X.com/rest/reference/get/trends/available GET trends/available}.
      ...
      # @option options [String] :lang The language which X should render in for this user. The language must be specified by the appropriate two letter ISO 639-1 representation. Currently supported languages are provided by {https://dev.X.com/rest/reference/get/help/languages GET help/languages}.
      ...
      def settings(options = {})
        ...
        # https://dev.X.com/issues/59
        response[:trend_location] = response.fetch(:trend_location, []).first
        X::Settings.new(response)
      end

      # Returns the requesting user if authentication was successful, otherwise raises {X::Error::Unauthorized}
      #
      # @see https://dev.X.com/rest/reference/get/account/verify_credentials
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::User] The authenticated user.
      # @param options [Hash] A customizable set of options.
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      def verify_credentials(options = {})
        perform_get_with_object("/1.1/account/verify_credentials.json", options, X::User)
      end

      # Sets which device X delivers updates to for the authenticating user
      #
      # @see https://dev.X.com/rest/reference/post/account/update_delivery_device
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::User] The authenticated user.
      ...
      def update_delivery_device(device, options = {})
        perform_post_with_object("/1.1/account/update_delivery_device.json", options.merge(device: device), X::User)
      end

      # Sets values that users are able to set under the "Account" tab of their settings page
      #
      # @see https://dev.X.com/rest/reference/post/account/update_profile
      ...
      def update_profile(options = {})
        perform_post_with_object("/1.1/account/update_profile.json", options, X::User)
      end

      # Updates the authenticating user's profile background image
      #
      # @see https://dev.X.com/rest/reference/post/account/update_profile_background_image
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::User] The authenticated user.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/account/update_profile_image
      ...
      #
      # @see https://dev.X.com/rest/reference/get/blocks/list
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] User objects that the authenticating user is blocking.
      # @param options [Hash] A customizable set of options.
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      def blocked(options = {})
        perform_get_with_cursor("/1.1/blocks/list.json", options, :users, X::User)
      end

      # Returns an array of numeric user IDs the authenticating user is blocking
      #
      # @see https://dev.X.com/rest/reference/get/blocks/ids
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor] Numeric user IDs the authenticating user is blocking.
      ...
      # @param user [Integer, String, URI, X::User] A X user ID, screen name, URI, or object.
      # @param options [Hash] A customizable set of options.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/blocks/create
      # @note Destroys a friendship to the blocked user if it exists.
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The blocked users.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/blocks/destroy
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The un-blocked users.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/users/lookup
      # @rate_limited Yes
      # @authentication Required
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The requested users.
      ...
      def users(*args)
        ...
        flat_pmap(arguments.each_slice(MAX_USERS_PER_REQUEST)) do |users|
          perform_get_with_objects("/1.1/users/lookup.json", merge_users(arguments.options, users), X::User)
        end
      end

      # @see https://dev.X.com/rest/reference/get/users/show
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::User] The requested user.
      ...
      def user(*args)
        ...
        if arguments.last || user_id?
          ...
          perform_get_with_object("/1.1/users/show.json", arguments.options, X::User)
        else
      ...
      #
      # @see https://dev.X.com/rest/reference/get/users/search
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>]
      ...
      def user_search(query, options = {})
        options = options.dup
        perform_get_with_objects("/1.1/users/search.json", options.merge(q: query), X::User)
      end

      # Returns an array of users that the specified user can contribute to
      #
      # @see https://dev.X.com/rest/reference/get/users/contributees
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>]
      ...
      #
      # @see https://dev.X.com/rest/reference/get/users/contributors
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>]
      ...
      #
      # @see https://dev.X.com/rest/reference/post/account/remove_profile_banner
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [nil]
      ...
      #
      # @see https://dev.X.com/rest/reference/post/account/update_profile_banner
      ...
      # @rate_limited No
      # @authentication Requires user context
      # @raise [X::Error::BadRequest] Error raised when either an image was not provided or the image data could not be processed.
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @raise [X::Error::UnprocessableEntity] Error raised when the image could not be resized or is too large.
      # @return [nil]
      ...
      #
      # @see https://dev.X.com/rest/reference/get/users/profile_banner
      ...
      def profile_banner(*args)
        ...
        perform_get_with_object("/1.1/users/profile_banner.json", arguments.options, X::ProfileBanner)
      end

      # Mutes the users specified by the authenticating user
      #
      # @see https://dev.X.com/rest/reference/post/mutes/users/create
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The muted users.
      # @overload mute(*users)
      #   @param users [Enumerable<Integer, String, X::User>] A collection of X user IDs, screen names, or objects.
      ...
      #
      # @see https://dev.X.com/rest/reference/post/mutes/users/destroy
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] The un-muted users.
      ...
      #
      # @see https://dev.X.com/rest/reference/get/mutes/users/list
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::User>] User objects that the authenticating user is muting.
      # @param options [Hash] A customizable set of options.
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      def muted(options = {})
        perform_get_with_cursor("/1.1/mutes/users/list.json", options, :users, X::User)
      end

      # Returns an array of numeric user IDs the authenticating user is muting
      #
      # @see https://dev.X.com/rest/reference/get/mutes/users/ids
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::Cursor] Numeric user IDs the authenticating user is muting
    ...
    private
      ...
      def post_profile_image(path, image, options)
        response = X::REST::Request.new(self, :multipart_post, path, options.merge(key: :image, file: image)).perform
        X::User.new(response)
      end
    end
  end
