...
module X
  module REST
    module Timelines
      ...
      #
      # @see https://dev.X.com/rest/reference/get/statuses/mentions_timeline
      ...
      def mentions_timeline(options = {})
        perform_get_with_objects("/1.1/statuses/mentions_timeline.json", options, X::Tweet)
      end
      alias mentions mentions_timeline

      # Returns the 20 most recent Tweets posted by the specified user
      #
      # @see https://dev.X.com/rest/reference/get/statuses/user_timeline
      ...
      def user_timeline(*args)
        objects_from_response_with_user(X::Tweet, :get, "/1.1/statuses/user_timeline.json", args)
      end
      ...
      #
      # @see https://dev.X.com/rest/reference/get/statuses/home_timeline
      ...
      def home_timeline(options = {})
        perform_get_with_objects("/1.1/statuses/home_timeline.json", options, X::Tweet)
      end
      ...
      #
      # @see https://dev.X.com/rest/reference/get/statuses/retweets_of_me
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::Tweet>]
      ...
      def retweets_of_me(options = {})
        perform_get_with_objects("/1.1/statuses/retweets_of_me.json", options, X::Tweet)
      end
