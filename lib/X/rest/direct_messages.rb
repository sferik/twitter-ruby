...
require "X/direct_message_event"
...
module X
  module REST
    module DirectMessages
      ...
      # @see https://developer.X.com/en/docs/direct-messages/sending-and-receiving/api-reference/list-events
      ...
      # @return [Array<X::DirectMessageEvent>] Direct message events sent by and received by the authenticating user.
      ...
      def direct_messages_events(options = {})
        ...
        perform_get_with_cursor("/1.1/direct_messages/events/list.json", options.merge!(no_default_cursor: true, count: 50, limit: limit), :events, X::DirectMessageEvent)
      end
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::DirectMessage>] Direct messages sent by and received by the authenticating user.
      # @param options [Hash] A customizable set of options.
      # @option options [Integer] :count Specifies the number of records to retrieve. Must be less than or equal to 50. Default is 20
      # @option options [String] :cursor Specifies the cursor position of results to retrieve.
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::DirectMessage>] Direct messages received by the authenticating user.
      # @param options [Hash] A customizable set of options.
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::DirectMessage>] Direct messages sent by the authenticating user.
      # @param options [Hash] A customizable set of options.
      # @option options [Integer] :count Specifies the number of records (sent and received dms) to retrieve. Must be less than or equal to 50. Default is 20
      # @option options [String] :cursor Specifies the cursor position of results to retrieve.
      ...
      #
      # @see https://developer.X.com/en/docs/direct-messages/sending-and-receiving/api-reference/get-event
      # @note This method requires an access token with RWD (read, write & direct message) permissions. Consult The Application Permission Model for more information.
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::DirectMessage] The requested message.
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::DirectMessageEvent] The requested message.
      # @param id [Integer] A direct message ID.
      # @param options [Hash] A customizable set of options.
      def direct_message_event(id, options = {})
        options = options.dup
        options[:id] = id
        perform_get_with_object("/1.1/direct_messages/events/show.json", options, X::DirectMessageEvent)
      end
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<X::DirectMessage>] The requested messages.
      ...
      #
      #   @see https://dev.X.com/rest/reference/get/direct_messages/show
      ...
      #
      # @see https://developer.X.com/en/docs/direct-messages/sending-and-receiving/api-reference/delete-message-event
      # @note This method requires an access token with RWD (read, write & direct message) permissions. Consult The Application Permission Model for more information.
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [nil] Response body from X is nil if successful
      ...
      #
      # @see https://developer.X.com/en/docs/direct-messages/sending-and-receiving/api-reference/new-event
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::DirectMessage] The sent message.
      # @param user [Integer, String, X::User] A X user ID
      # @param text [String] The text of your direct message, up to 10,000 characters.
      # @param options [Hash] A customizable set of options.
      def create_direct_message(user_id, text, options = {})
        event = perform_request_with_object(:json_post, "/1.1/direct_messages/events/new.json", format_json_options(user_id, text, options), X::DirectMessageEvent)
      ...
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [X::DirectMessageEvent] The created direct message event.
      ...
      def create_direct_message_event(*args)
        ...
        response = X::REST::Request.new(self, :json_post, "/1.1/direct_messages/events/new.json", options).perform
        X::DirectMessageEvent.new(response[:event])
      end

      # Create a new direct message event to the specified user from the authenticating user with media
      #
      # @see https://developer.X.com/en/docs/direct-messages/sending-and-receiving/api-reference/new-event
      # @see https://developer.X.com/en/docs/direct-messages/message-attachments/guides/attaching-media
      # @note This method requires an access token with RWD (read, write & direct message) permissions. Consult The Application Permission Model for more information.
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [X::Error::Unauthorized] Error raised when supplied user credentials are not valid.
