    ...
    module SuggestedUsers
      ...
      def suggestions(*args)
        ...
        if arguments.last
          ...
          perform_get_with_object('/1.1/users/suggestions.json', arguments.options, Twitter::Suggestion)
        end
      end
      ...
      def suggest_users(slug, options = {})
        perform_get_with_object("/1.1/users/suggestions/#{slug}/members.json", options, Twitter::User)
      end
    end
  end
end
