  ...
  module REST
    module Users
      ...
      def settings(options = {})
        ...
        response = perform_request(request_method.to_sym, "/2/account/settings.json", options)
      ...
      def verify_credentials(options = {})
        perform_get_with_object("/2/account/verify_credentials.json", options, Twitter::User)
      end
      ...
      def update_delivery_device(device, options = {})
        perform_post_with_object("/2/account/update_delivery_device.json", options.merge(device: device), Twitter::User)
      end
      ...
      def update_profile(options = {})
        perform_post_with_object("/2/account/update_profile.json", options, Twitter::User)
      end
      ...
      def update_profile_background_image(image, options = {})
        post_profile_image("/2/account/update_profile_background_image.json", image, options)
      end
      ...
      def update_profile_image(image, options = {})
        post_profile_image("/2/account/update_profile_image.json", image, options)
      end
      ...
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      def blocked(options = {})
        perform_get_with_cursor("/2/blocks/list.json", options, :users, Twitter::User)
      end
      ...
      def blocked_ids(*args)
        ...
        perform_get_with_cursor("/2/blocks/ids.json", arguments.options, :ids)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def block(*args)
        parallel_users_from_response(:post, "/2/blocks/create.json", args)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def unblock(*args)
        parallel_users_from_response(:post, "/2/blocks/destroy.json", args)
      end
      ...
      #   @param users [Enumerable<Integer, String, Twitter::User>] A collection of Twitter user IDs, screen names, or objects.
      #   @param options [Hash] A customizable set of options.
      def users_using_usernames(*args)
        arguments = Twitter::Arguments.new(args)
        flat_pmap(arguments.each_slice(MAX_USERS_PER_REQUEST)) do |users|
          perform_get_with_objects("/2/users/by", merge_users(arguments.options, users), Twitter::User)
        end
      end
      ...
      def user(*args)
        ...
        if arguments.last || user_id?
          # arguments.options.push("user.fields", "created_at,description,entities,id,location,name,pinned_tweet_id,profile_image_url,protected,url,username,verified,withheld")
          merge_user!(arguments.options, arguments.pop || user_id)
          # mw
          #/2/users/by?usernames= is for string usernames
          #/2/users?ids= is for ids
          perform_get_with_object("/2/users/by", arguments.options, Twitter::User)
        else
      ...
      def user?(user, options = {})
        ...
        perform_get("/2/users/show.json", options)
        true
      ...
      def user_search(query, options = {})
        options = options.dup
        perform_get_with_objects("/2/users/search.json", options.merge(q: query), Twitter::User)
      end
      ...
      def contributees(*args)
        users_from_response(:get, "/2/users/contributees.json", args)
      end
      ...
      def contributors(*args)
        users_from_response(:get, "/2/users/contributors.json", args)
      end
      ...
      def remove_profile_banner(options = {})
        perform_post("/2/account/remove_profile_banner.json", options)
        true
      end
      ...
      def update_profile_banner(banner, options = {})
        perform_post("/2/account/update_profile_banner.json", options.merge(banner: banner))
        true
      end
      ...
      def profile_banner(*args)
        ...
        perform_get_with_object("/2/users/profile_banner.json", arguments.options, Twitter::ProfileBanner)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def mute(*args)
        parallel_users_from_response(:post, "/2/mutes/users/create.json", args)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def unmute(*args)
        parallel_users_from_response(:post, "/2/mutes/users/destroy.json", args)
      end
      ...
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      def muted(options = {})
        perform_get_with_cursor("/2/mutes/users/list.json", options, :users, Twitter::User)
      end
      ...
      def muted_ids(*args)
        arguments = Twitter::Arguments.new(args)
        merge_user!(arguments.options, arguments.pop)
        perform_get_with_cursor("/2/mutes/users/ids.json", arguments.options, :ids)
      end
