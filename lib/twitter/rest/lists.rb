...
module Twitter
  module REST
    module Lists
      ...
      #   @option options [Boolean] :reverse Set this to true if you would like owned lists to be returned first.
      def lists(*args)
        objects_from_response_with_user(Twitter::List, :get, "/2/lists/list.json", args)
      end
      ...
      def list_timeline(*args)
        ...
        perform_get_with_objects("/2/lists/statuses.json", arguments.options, Twitter::Tweet)
      end
      ...
      def remove_list_member(*args)
        list_from_response_with_user("/2/lists/members/destroy.json", args)
      end
      ...
      def list_subscribers(*args)
        cursor_from_response_with_list("/2/lists/subscribers.json", args)
      end
      ...
      def list_subscribe(*args)
        list_from_response(:post, "/2/lists/subscribers/create.json", args)
      end
      ...
      def list_subscriber?(*args)
        list_user?(:get, "/2/lists/subscribers/show.json", args)
      end
      ...
      def list_unsubscribe(*args)
        list_from_response(:post, "/2/lists/subscribers/destroy.json", args)
      end
      ...
      def add_list_members(*args)
        list_from_response_with_users("/2/lists/members/create_all.json", args)
      end
      ...
      def list_member?(*args)
        list_user?(:get, "/2/lists/members/show.json", args)
      end
      ...
      def list_members(*args)
        cursor_from_response_with_list("/2/lists/members.json", args)
      end
      ...
      def add_list_member(*args)
        list_from_response_with_user("/2/lists/members/create.json", args)
      end
      ...
      def destroy_list(*args)
        list_from_response(:post, "/2/lists/destroy.json", args)
      end
      ...
      def list_update(*args)
        list_from_response(:post, "/2/lists/update.json", args)
      end
      ...
      def create_list(name, options = {})
        perform_post_with_object("/2/lists/create.json", options.merge(name: name), Twitter::List)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def list(*args)
        list_from_response(:get, "/2/lists/show.json", args)
      end
      ...
      def subscriptions(*args)
        cursor_from_response_with_user(:lists, Twitter::List, "/2/lists/subscriptions.json", args)
      end
      ...
      def remove_list_members(*args)
        list_from_response_with_users("/2/lists/members/destroy_all.json", args)
      end
      ...
      def owned_lists(*args)
        cursor_from_response_with_user(:lists, Twitter::List, "/2/lists/ownerships.json", args)
      end
