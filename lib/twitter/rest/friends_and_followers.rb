...
module Twitter
  module REST
    module FriendsAndFollowers
      ...
      #   @param options [Hash] A customizable set of options.
      def friend_ids(*args)
        cursor_from_response_with_user(:ids, nil, "/2/friends/ids.json", args)
      end
      ...
      def friendships(*args)
        ...
        perform_get_with_objects("/2/friendships/lookup.json", arguments.options, Twitter::User)
      end
      ...
      def friendships_incoming(options = {})
        perform_get_with_cursor("/2/friendships/incoming.json", options, :ids)
      end
      ...
      def friendships_outgoing(options = {})
        perform_get_with_cursor("/2/friendships/outgoing.json", options, :ids)
      end
      ...
      #   @param options [Hash] A customizable set of options.
      def unfollow(*args)
        parallel_users_from_response(:post, "/2/friendships/destroy.json", args)
      end
      ...
      def friendship_update(user, options = {})
        ...
        perform_post_with_object("/2/friendships/update.json", options, Twitter::Relationship)
      end
      ...
      def friendship(source, target, options = {})
        ...
        perform_get_with_object("/2/friendships/show.json", options, Twitter::Relationship)
      end
      ...
      #   @option options [Boolean, String, Integer] :include_user_entities The user entities node will be disincluded when set to false.
      def followers(*args)
        cursor_from_response_with_user(:users, Twitter::User, "/2/followers/list.json", args)
      end
      ...
      #   @option options [Boolean, String, Integer] :include_user_entities The user entities node will be disincluded when set to false.
      def friends(*args)
        cursor_from_response_with_user(:users, Twitter::User, "/2/friends/list.json", args)
      end
      ...
      def no_retweet_ids(options = {})
        perform_get("/2/friendships/no_retweets/ids.json", options).collect(&:to_i)
      end
