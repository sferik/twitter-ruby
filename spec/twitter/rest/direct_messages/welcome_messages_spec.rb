...
describe X::REST::DirectMessages::WelcomeMessages do
  before do
  ...
  context "Welcome Messages" do
    describe "#create_welcome_message" do
      ...
      it "returns the created welcome message" do
        ...
        expect(welcome_message).to be_a X::DirectMessages::WelcomeMessage
      ...
      it "sets the entities" do
        ...
        welcome_message = @client.create_welcome_message("Url: http://example.com/expanded and #hashtag and @XSupport")
        expect(welcome_message.hashtags).to be_an(Array)
        expect(welcome_message.hashtags.first).to be_a(X::Entity::Hashtag)
        ...
        expect(welcome_message.user_mentions.first).to be_a(X::Entity::UserMention)
        ...
        expect(welcome_message.user_mentions.first.name).to eq("X Support")
        expect(welcome_message.uris).to be_an(Array)
        expect(welcome_message.uris.first).to be_a(X::Entity::URI)
    ...
    describe "#welcome_message_list" do
      ...
      it "returns the welcome message list" do
        ...
        expect(welcome_messages.first).to be_a X::DirectMessages::WelcomeMessage
  ...
  context "Welcome Message Rules" do
    describe "#create_welcome_message_rule" do
      ...
      it "returns the created welcome message rule" do
        ...
        expect(welcome_message_rule).to be_a X::DirectMessages::WelcomeMessageRule
    ...
    describe "#welcome_message_rule_list" do
      ...
      it "returns the welcome message rule list" do
        ...
        expect(welcome_message_rules.first).to be_a X::DirectMessages::WelcomeMessageRule
