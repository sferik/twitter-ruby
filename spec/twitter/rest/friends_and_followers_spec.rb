...
describe Twitter::REST::FriendsAndFollowers do
  ...
  describe "#friend_ids" do
    ...
    context "with a user ID passed" do
      before do
        stub_get("/2/friends/ids.json").with(query: {user_id: "7505382", cursor: "-1"}).to_return(body: fixture("ids_list.json"), headers: {content_type: "application/json; charset=utf-8"})
      end
      ...
      context "with each" do
        before do
          stub_get("/2/friends/ids.json").with(query: {user_id: "7505382", cursor: "1305102810874389703"}).to_return(body: fixture("ids_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
        end

        it "requests the correct resource" do
          @client.friend_ids(7_505_382).each {}
          expect(a_get("/2/friends/ids.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
          expect(a_get("/2/friends/ids.json").with(query: {user_id: "7505382", cursor: "1305102810874389703"})).to have_been_made
        end
      end
    end
  ...
  describe "#follower_ids" do
    ...
    context "with a user ID passed" do
      before do
        stub_get("/2/followers/ids.json").with(query: {user_id: "7505382", cursor: "-1"}).to_return(body: fixture("ids_list.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.follower_ids(7_505_382)
        expect(a_get("/2/followers/ids.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
      end

      context "with each" do
        before do
          stub_get("/2/followers/ids.json").with(query: {user_id: "7505382", cursor: "1305102810874389703"}).to_return(body: fixture("ids_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
        end

        it "requests the correct resource" do
          @client.follower_ids(7_505_382).each {}
          expect(a_get("/2/followers/ids.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
          expect(a_get("/2/followers/ids.json").with(query: {user_id: "7505382", cursor: "1305102810874389703"})).to have_been_made
        end
      end
    end
  ...
  describe "#friendships" do
    ...
    context "with user IDs passed" do
      before do
        stub_get("/2/friendships/lookup.json").with(query: {user_id: "7505382,14100886"}).to_return(body: fixture("friendships.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.friendships(7_505_382, 14_100_886)
        expect(a_get("/2/friendships/lookup.json").with(query: {user_id: "7505382,14100886"})).to have_been_made
      end
    end
  ...
  describe "#friendships_incoming" do
    before do
      stub_get("/2/friendships/incoming.json").with(query: {cursor: "-1"}).to_return(body: fixture("ids_list.json"), headers: {content_type: "application/json; charset=utf-8"})
    end

    it "requests the correct resource" do
      @client.friendships_incoming
      expect(a_get("/2/friendships/incoming.json").with(query: {cursor: "-1"})).to have_been_made
    end
    ...
    context "with each" do
      before do
        stub_get("/2/friendships/incoming.json").with(query: {cursor: "1305102810874389703"}).to_return(body: fixture("ids_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.friendships_incoming.each {}
        expect(a_get("/2/friendships/incoming.json").with(query: {cursor: "1305102810874389703"})).to have_been_made
      end
    end
  end
  ...
  describe "#friendships_outgoing" do
    before do
      stub_get("/2/friendships/outgoing.json").with(query: {cursor: "-1"}).to_return(body: fixture("ids_list.json"), headers: {content_type: "application/json; charset=utf-8"})
    end

    it "requests the correct resource" do
      @client.friendships_outgoing
      expect(a_get("/2/friendships/outgoing.json").with(query: {cursor: "-1"})).to have_been_made
    end
    ...
    context "with each" do
      before do
        stub_get("/2/friendships/outgoing.json").with(query: {cursor: "1305102810874389703"}).to_return(body: fixture("ids_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.friendships_outgoing.each {}
        expect(a_get("/2/friendships/outgoing.json").with(query: {cursor: "1305102810874389703"})).to have_been_made
      end
    end
  end
  ...
  describe "#friendship" do
    ...
    context "with user IDs passed" do
      before do
        stub_get("/2/friendships/show.json").with(query: {source_id: "7505382", target_id: "14100886"}).to_return(body: fixture("following.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.friendship(7_505_382, 14_100_886)
        expect(a_get("/2/friendships/show.json").with(query: {source_id: "7505382", target_id: "14100886"})).to have_been_made
      end
    end
  ...
  describe "#followers" do
    ...
    context "with a user ID passed" do
      before do
        stub_get("/2/followers/list.json").with(query: {user_id: "7505382", cursor: "-1"}).to_return(body: fixture("followers_list.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.followers(7_505_382)
        expect(a_get("/2/followers/list.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
      end

      context "with each" do
        before do
          stub_get("/2/followers/list.json").with(query: {user_id: "7505382", cursor: "1419103567112105362"}).to_return(body: fixture("followers_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
        end

        it "requests the correct resource" do
          @client.followers(7_505_382).each {}
          expect(a_get("/2/followers/list.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
          expect(a_get("/2/followers/list.json").with(query: {user_id: "7505382", cursor: "1419103567112105362"})).to have_been_made
        end
      end
    end
  ...
  describe "#friends" do
    ...
    context "with a user ID passed" do
      before do
        stub_get("/2/friends/list.json").with(query: {user_id: "7505382", cursor: "-1"}).to_return(body: fixture("friends_list.json"), headers: {content_type: "application/json; charset=utf-8"})
      end

      it "requests the correct resource" do
        @client.friends(7_505_382)
        expect(a_get("/2/friends/list.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
      end

      context "with each" do
        before do
          stub_get("/2/friends/list.json").with(query: {user_id: "7505382", cursor: "1418947360875712729"}).to_return(body: fixture("friends_list2.json"), headers: {content_type: "application/json; charset=utf-8"})
        end

        it "requests the correct resource" do
          @client.friends(7_505_382).each {}
          expect(a_get("/2/friends/list.json").with(query: {user_id: "7505382", cursor: "-1"})).to have_been_made
          expect(a_get("/2/friends/list.json").with(query: {user_id: "7505382", cursor: "1418947360875712729"})).to have_been_made
        end
      end
    end
  ...
  describe "#no_retweet_ids" do
    before do
      stub_get("/2/friendships/no_retweets/ids.json").to_return(body: fixture("ids.json"), headers: {content_type: "application/json; charset=utf-8"})
    end

    it "requests the correct resource" do
      @client.no_retweet_ids
      expect(a_get("/2/friendships/no_retweets/ids.json")).to have_been_made
    end
