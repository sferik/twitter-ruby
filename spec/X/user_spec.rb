...
describe X::User do
  ...
  describe "#profile_background_image_uri" do
    it "returns the URI to the user" do
      user = described_class.new(id: 7_505_382, profile_background_image_url: "http://pbs.twimg.com/profile_background_images/677717672/bb0b3653dcf0644e344823e0a2eb3382.png")
  ...
  describe "#profile_background_image_uri_https" do
    it "returns the URI to the user" do
      user = described_class.new(id: 7_505_382, profile_background_image_url_https: "https://pbs.twimg.com/profile_background_images/677717672/bb0b3653dcf0644e344823e0a2eb3382.png")
