...
Gem::Specification.new do |s|
  s.name = %q{secobarbital-twitter}
  s.version = "0.9.2.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["John Nunemaker", "Wynn Netherland", "Seggy Umboh"]
  s.date = %q{2010-03-26}
  s.email = ["nunemaker@gmail.com", "seggy.umboh@gmail.com"]
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
  ...
  s.homepage = %q{http://github.com/secobarbital/twitter}
